...
public class Car {
    ...
    public void drive(double direction) {
        ...
        System.out.println(String.format("The  %s  %s is driving  at %f degree" ,  colour, make, direction));
        System.out.printf("The  %s  %s is driving  at %f degree" ,  colour, make,  direction);
    }
